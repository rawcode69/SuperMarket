...
public class CustomerView extends javax.swing.JFrame {
                            ...
                            .addGroup(fromPanelLayout.createSequentialGroup()
                                .addGroup(fromPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(fromPanelLayout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(custSalaryLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 89, Short.MAX_VALUE)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(fromPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(fromPanelLayout.createSequentialGroup()
                                        .addComponent(custSalaryText, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(356, 356, 356))
                                    .addComponent(custNameText, javax.swing.GroupLayout.DEFAULT_SIZE, 463, Short.MAX_VALUE))))
                        .addContainerGap())
                    .addGroup(fromPanelLayout.createSequentialGroup()
    ...
    private void loadAllCustomers() {
        ...
        try {
            ...
            String[] columNames = {"ID", "Name", "Address", "City"};

            DefaultTableModel tbm = new DefaultTableModel(columNames, 0) {
                @Override
    ...
    private void searchCustomer() {
        ...
        try {
            ...
            custSalaryText.setText(Double.toString(customer.getSalary()));
